...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h3 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-plus-circle mr-2"></i>Thêm Chuyên khoa mới
        </h3>
    </div>

    <div class="bg-white rounded-lg shadow-md p-8">
        <form action="<?= APP_URL ?>/admin/specializations/store" method="POST" class="space-y-6">
            <!-- Tên chuyên khoa -->
            <div>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"
                          placeholder="Mô tả về chuyên khoa..."><?= $_SESSION['old']['description'] ?? '' ?></textarea>
            </div>
            ...
            <div class="flex gap-4">
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Lưu chuyên khoa
                </button>
